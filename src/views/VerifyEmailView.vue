  ...
  <section class="py-8 bg-ct-blue-600 min-h-screen grid place-items-center">
    <div>
      ...
      >
        ...
        <LoadingButton :loading="isLoading">Verificar Emaill</LoadingButton>
      </form>
    </div>
  </section>
</template>
...
const verifyEmailSchema = toFormValidator(
  zod.object({
    verificationCode: zod.string().min(1, 'Verificação do código obrigatória'),
  })
);
